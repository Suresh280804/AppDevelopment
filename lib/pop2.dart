              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    SizedBox(height: 16),
                    Text(
                      "At Housing Valley, we understand that finding the perfect home can be overwhelming, which is why we offer personalized assistance from experienced real estate agents.",
                      textAlign: TextAlign.center,
                      style: TextStyle(
                        fontSize: 16,
                      ),
